...
Super Mario Land Second Subcon 1.7 (EXPERT):

* overall less illusions (except 1-3)
* slightly different (& also harder) levels
* fixed missing sprites in 2-3 [1.7]
* extra Title Screen for EXPERT-mode [1.7]

Super Mario Land Second Subcon 1.7 (LITE):

* better indicators for fake/invisible blocks
* easier 4-1 (removed 'mirror'-gimmick)
* fixed missing sprites in 2-3 [1.7]
* extra Title Screen for LITE-mode [1.7]
  
Super Mario Land Second Subcon 1.7 (ORIGINAL):
